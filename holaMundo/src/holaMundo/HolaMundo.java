...
public class HolaMundo {
	...
	public static void ejemplosComentarios() {
		...
		System.out.println("Hola Mundo");
		/*
		 * System.out.println("Hola Mundo a"); System.out.println("Hola Mundo a");
...
//		
		System.out.printf("%-12s%14s\n", "NOMBRE", "SALARIO"); // el numero en positivo alinea a la derecha, en negativo
																// a la izquierdo
		System.out.println("----------------------------");
	...
	public static void ejemplosScanner() { // leer de la consola
		...
		System.out.println("Hola " + nombre + " me encanta " + localidad + " y que usted gane " + salario
				+ " y que le gustaria ganar " + salarioDeseado);
